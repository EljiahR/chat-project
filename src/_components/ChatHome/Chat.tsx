...
const Chat: React.FC<Props> = ({chatMessages, handleChannelMenuDisplay}) => {
    ...
    return (
            <div id="chat" className="h-full flex flex-col gap-1">
                ...
                <div id="chat-box" className="grow overflow-y-auto overflow-x-hidden h-50 flex flex-col-reverse bg-gray-700 rounded p-1 inset-shadow-sm inset-shadow-black gap-2">
                    {chatMessages}
                </div>
                <MessageControls />
            </div>
