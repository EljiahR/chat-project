...
export const notificationBubble = "absolute inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-blue-500 border-2 border-white rounded-full -top-1 -end-1 dark:border-gray-900";
