...
export const mobileSubMenuStyle = "visible bg-gray-600 p-5 sm:p-0 rounded-xl sm:bg-inherit absolute sm:static h-80 sm:h-auto w-90 sm:w-auto top-1/6 -translate-y-1/6 left-1/2 -translate-x-1/2 sm:translate-0 z-4";
export const draggableSubMenuStyle = "absolute sm:static top-1/6 -translate-y-1/6 left-1/2 -translate-x-1/2 sm:translate-0 visible w-90 sm:min-w-1/4 bg-gray-600 p-2 bg-light border border-2 rounded flex flex-col gap-2 z-4";
