export const pageBaseStyle = "size-full bg-gray-900 text-white p-5";
export const pageSignInStyle = pageBaseStyle + " flex items-center justify-center flex-col";
export const pageChatHomeStyle = pageBaseStyle + " grid grid-cols-4 gap-5";
export const buttonStyle = "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800";
